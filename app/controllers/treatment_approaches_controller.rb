  ...
  def create
    ...
    respond_to do |format|
      if @treatment_approach.save
        format.html do
          redirect_to treatment_approach_url(@treatment_approach),
                      notice: 'Treatment approach was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @treatment_approach.update(treatment_approach_params)
        format.html do
          redirect_to treatment_approach_url(@treatment_approach),
                      notice: 'Treatment approach was successfully updated.'
        end
