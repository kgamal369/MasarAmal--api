  ...
  def create
    ...
    respond_to do |format|
      if @mental_service.save
        format.html do
          redirect_to mental_service_url(@mental_service), notice: 'Mental service was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @mental_service.update(mental_service_params)
        format.html do
          redirect_to mental_service_url(@mental_service), notice: 'Mental service was successfully updated.'
        end
