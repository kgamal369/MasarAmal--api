...
ActiveRecord::Schema[7.1].define(version: 2024_02_20_132010) do
  create_schema "masar"
  ...
  create_table "cms_section_components", primary_key: "sectioncomponentid", id: :serial, force: :cascade do |t|
    t.integer "sectionid", null: false
    t.integer "componentid", null: false
  ...
  create_table "cms_values", primary_key: "valueid", id: :serial, force: :cascade do |t|
    t.integer "pagesectionid", null: false
    t.integer "sectioncomponentid", null: false
    t.integer "languageid", null: false
    t.string "value", null: false

    t.unique_constraint ["pagesectionid", "sectioncomponentid", "languageid"], name: "cms_values_un"
  end
  ...
  add_foreign_key "cms_values", "cms_languages", column: "languageid", primary_key: "languageid", name: "cms_values_lanuguageid_fk", on_delete: :cascade
  add_foreign_key "cms_values", "cms_page_sections", column: "pagesectionid", primary_key: "pagesectionid", name: "cms_values_pagesectionid_fk", on_delete: :cascade
  add_foreign_key "cms_values", "cms_section_components", column: "sectioncomponentid", primary_key: "sectioncomponentid", name: "cms_values_sectioncomponentid_fk", on_delete: :cascade
